...
class JarvisUI(QWidget):
    ...
    def run_main_file(self):
        try:
            ...
            path_to_main_py = os.path.join(current_directory, r"C:\Users\PRATI\Desktop\JARVIS4.1\MAIN\main.py")

            command = ["python", path_to_main_py]
            self.process = subprocess.Popen(
                command, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True, cwd=current_directory)
